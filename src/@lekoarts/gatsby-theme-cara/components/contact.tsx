  ...
  <div>  
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      ...
      <UpDownWide>
        ...
        <Svg icon="triangle" hiddenMobile width={12} color="icon_darkest" left="55%" top="10%" />
      </UpDownWide>
      <Svg icon="circle" hiddenMobile width={4} color="icon_darker" left="40%" top="40%" />
      <Svg icon="tree" hiddenMobile width={64} color="icon_darker" left="92.5%" top="60%" />
      <Svg icon="box" width={12} hiddenMobile color="icon_red" left="20%" top="30%" />
      <Svg icon="hexa" width={8} stroke color="icon_darkest" left="80%" top="70%" />
      <Svg icon="triangle" hiddenMobile width={48} stroke color="icon_green" left="70%" top="-10%" />
    </Divider>
  </div>
)
