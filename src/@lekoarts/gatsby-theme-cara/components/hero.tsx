  ...
  <div>
    ...
    <Divider speed={0.2} offset={offset} factor={factor}>
      <UpDown>
        ...
        <Svg icon="bike" hiddenMobile width={40} stroke color="icon_blue" left="40%" top="70%" />
      ...
      <UpDownWide>
        ...
        {/* <Svg icon="cross" width={16} stroke color="icon_pink" left="28%" top="15%" /> */}
            <Svg icon="boot" hiddenMobile width={16} stroke color="icon_purple" left="28%" top="15%" />
      ...
      <Svg icon="tent" hiddenMobile width={32} stroke color="icon_darker" left="65%" top="77%" />
      {/* <Svg icon="triangle" width={8} stroke color="icon_darker" left="25%" top="5%" /> */}
        <Svg icon="mountain" width={32} color="icon_darkest" left="35%" top="5%" /> 
      ...
      <Svg icon="trees"  hiddenMobile width={12} color="icon_green" left="10%" top="10%" />
      <Svg icon="trees" width={20} hiddenMobile color="icon_darker" stroke left="45%" top="30%" />
      <Svg icon="tree" width={16} hiddenMobile stroke color="icon_darker" left="10%" top="50%" />
      <Svg icon="trees" width={20} color="icon_darker" left="80%" top="70%" />
    </Divider>
