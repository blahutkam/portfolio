...
const Hero = ({ offset, factor = 1 }: { offset: number; factor?: number }) => (
  <div>
    ...
    <Divider speed={0.2} offset={offset} factor={factor}>
      ...
      {/* <Svg icon="tree" hiddenMobile width={16} color="icon_darkest" left="60%" top="25%" /> */}
      {/* <Svg icon="tree" hiddenMobile width={32} color="icon_darker" left="40%" top="110%" /> */}
      ...
      <Svg icon="trees" hiddenMobile width={20} hiddenMobile color="DarkSeaGreen" left="50%" top="15%" />
