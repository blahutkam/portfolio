...
const icons = {
  ...
  boot: {
    ...
    shape: (
      <React.Fragment>
        <svg viewBox="0 0 100 100">
            <g id="Transition" transform="translate(-570 -432)">
                <circle id="Ellipse_293" data-name="Ellipse 293" cx="1.703" cy="1.703" r="1" transform="translate(587.096 457.758)"/>
                <circle id="Ellipse_294" data-name="Ellipse 294" cx="1.703" cy="1.703" r="1" transform="translate(583.69 461.165)"/>
                <circle id="Ellipse_295" data-name="Ellipse 295" cx="1.703" cy="1.703" r="1" transform="translate(580.283 464.572)"/>
                <circle id="Ellipse_296" data-name="Ellipse 296" cx="1.703" cy="1.703" r="1." transform="translate(576.876 467.979)"/>
                <circle id="Ellipse_297" data-name="Ellipse 297" cx="1.703" cy="1.703" r="1" transform="translate(583.69 467.979)"/>
                <circle id="Ellipse_298" data-name="Ellipse 298" cx="1.703" cy="1.703" r="1" transform="translate(597.317 467.979)"/>
                <circle id="Ellipse_299" data-name="Ellipse 299" cx="1.703" cy="1.703" r="1" transform="translate(573.469 471.386)"/>
                <circle id="Ellipse_300" data-name="Ellipse 300" cx="1.703" cy="1.703" r="1" transform="translate(580.283 471.386)"/>
                <circle id="Ellipse_301" data-name="Ellipse 301" cx="1.703" cy="1.703" r="1" transform="translate(576.876 474.792)"/>
                <circle id="Ellipse_302" data-name="Ellipse 302" cx="1.703" cy="1.703" r="1" transform="translate(583.69 474.792)"/>
                <circle id="Ellipse_303" data-name="Ellipse 303" cx="1.703" cy="1.703" r="1" transform="translate(590.503 474.792)"/>
                <circle id="Ellipse_304" data-name="Ellipse 304" cx="1.703" cy="1.703" r="1" transform="translate(597.317 474.792)"/>
                <circle id="Ellipse_305" data-name="Ellipse 305" cx="1.703" cy="1.703" r="1" transform="translate(580.283 478.199)"/>
...
type IconType = "tree" | "trees" | "boot" | "bike" | "bag" | "fire" | "mountain" | "bee" | "tent" | "triangle" | "circle" | "arrowUp" | "upDown" | "box" | "hexa" | "cross"
